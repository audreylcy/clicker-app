...
public class QuizActivity5 extends AppCompatActivity {
    ...
    public void openActivity2(){
        Intent intent = new Intent(QuizActivity5.this, QuizActivity6.class);
    ...
    public void btnAHandler (View view){
        ...
        Intent intent = new Intent(QuizActivity5.this, Selecta.class);
    ...
    public void btnBHandler(View view){
        qnno = findViewById(R.id.qnno);
        String userqn = qnno.getText().toString();
        Intent intent = new Intent(QuizActivity5.this, Selectb.class);
        intent.putExtra("count", userqn);
        startActivity(intent);
    }
    ...
    public void btnCHandler(View view){
        qnno = findViewById(R.id.qnno);
        String userqn = qnno.getText().toString();
        Intent intent = new Intent(QuizActivity5.this, Selectc.class);
        intent.putExtra("count", userqn);
        startActivity(intent);
    }
    ...
    public void btnDHandler(View view){
        qnno = findViewById(R.id.qnno);
        String userqn = qnno.getText().toString();
        Intent intent = new Intent(QuizActivity5.this, Selectd.class);
        intent.putExtra("count", userqn);
        startActivity(intent);
    }
}
