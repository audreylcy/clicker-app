...
public class QuizActivity extends AppCompatActivity {
    ...
    public void btnAHandler (View view){
        ...
        Intent intent = new Intent(QuizActivity.this, Selecta.class);
    ...
    public void btnBHandler(View view){
        qnno = findViewById(R.id.qnno);
        String userqn = qnno.getText().toString();
        Intent intent = new Intent(QuizActivity.this, Selectb.class);
        intent.putExtra("count", userqn);
        startActivity(intent);
    }
    ...
    public void btnCHandler(View view){
        qnno = findViewById(R.id.qnno);
        String userqn = qnno.getText().toString();
        Intent intent = new Intent(QuizActivity.this, Selectc.class);
        intent.putExtra("count", userqn);
        startActivity(intent);
    }
    ...
    public void btnDHandler(View view){
        qnno = findViewById(R.id.qnno);
        String userqn = qnno.getText().toString();
        Intent intent = new Intent(QuizActivity.this, Selectd.class);
        intent.putExtra("count", userqn);
        startActivity(intent);
    }
}
